...
namespace Demo.Foundation.MediaLibrary.Configuration
{
    public class Settings
    {
        public static class Media
        {
            public static string ExternalBlobStorageProviderType => GetSetting("Media.ExternalBlobStorage.ProviderType");
            ...
            public static class AzureBlobStorage
            {
                ...
                // Default: NoRetry
                public static IRetryPolicy RetryPolicy => GetRetryPolicy(GetSetting("Media.AzureBlobStorage.RetryPolicy", "NoRetry"), TimeSpan.FromSeconds(3), 3);
                ...
                // Default: Verbose
                public static LogLevel OperationContextLogLevel => GetLogLevel(GetSetting("Media.AzureBlobStorage.OperationContext.LogLevel", "Verbose"));
        ...
        {
            bool success = Enum.TryParse(logLevelName, true, out LogLevel logLevel);
